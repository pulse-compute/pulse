...
See [Explicit JSON schemas](https://pulsecompute.io/v1.0.0-beta.3/guides/json-schemas/), [Project configuration](https://pulsecompute.io/v1.0.0-beta.3/reference/project-config/#json-schema-policy), and [Implementation packages](https://pulsecompute.io/v1.0.0-beta.3/packages/implementation-packages/).
