      ...
      runtime: {
        ...
        payload: {
          ...
          json: {
            ...
            maxBytes: 65536,
            schemas: [
              { namespace: 'app', name: 'CreateUserBody', type: 'CreateUserBody', source: './examples/schema-types.ts', codec: 'json' },
              { namespace: 'auth', name: 'LoginBody', type: 'LoginBody', source: './examples/schema-types.ts', codec: 'json' }
            ]
          }
        }
      }
