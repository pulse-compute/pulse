...
[complete result contract](./docs/packages/runtime.md#wall-time).
...
canonical-byte format. See [application-owned encoding](./docs/guides/json-schemas.md#encode-application-owned-text).
...
storage acceptance. See [application text decoding](./docs/guides/json-schemas.md#decode-application-owned-text).
