...
const CONFIG_SECTIONS = Object.freeze([
  ...
  Object.freeze({ id: 'crypto', title: 'Cryptographic requirements', description: 'Declare exact algorithms for the global or selected profile and resolve one target realization without fallback. This surface is part of the synchronized 1.0.0-beta.5 package set.' }),
...
const CONFIG_FIELDS = Object.freeze([
  ...
  field({ section: 'schemas', path: 'schemas.maxBytes', type: 'positive safe integer', default: '`65_536`', scope: 'structured schema text', description: 'Maximum UTF-8 bytes for schema decoding and encoding. Request transport and dev.maxBodyBytes may impose separate limits.', security: 'Raise deliberately; this is a memory and request-amplification boundary.', diagnostics: ['PULSE_SCHEMA_BODY_LIMIT_INVALID', 'PULSE_BODY_TOO_LARGE'] }),
