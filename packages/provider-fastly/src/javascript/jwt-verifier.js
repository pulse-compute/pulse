...
const FASTLY_JAVASCRIPT_JWT_VERIFIER_VERSION = 'pulse.fastly-javascript-jwt-verifier.v2';
const FASTLY_JAVASCRIPT_JWT_REALIZATIONS = Object.freeze({
  HS256: Object.freeze({
    algorithm: 'HS256',
...
const FASTLY_JAVASCRIPT_JWT_REALIZATION =
  FASTLY_JAVASCRIPT_JWT_REALIZATIONS.HS256;
...
function assertRuntimeBuiltin(cryptoProvider, jwtProvider) {
  if (
    ...
    throw jwtProvider.jwtError('PULSE_JWT_TARGET_UNSUPPORTED', {
      ...
      realization: FASTLY_JAVASCRIPT_JWT_REALIZATION.realization,
      implementation: FASTLY_JAVASCRIPT_JWT_REALIZATION.implementation,
      automaticFallback: false
    });
  }
...
function createFastlyJavascriptJwtVerify(options = {}) {
  const captureWallClock = options.captureWallClock || fastlyWallClock;
