...
> **Canonical documentation:** [Package guide](https://pulsecompute.io/v1.0.0-beta.4/packages/s3/)
>
...
`1.0.0-beta.4` release candidate. Provider, manifest, compiler and Native
...
See the [S3 guide](https://pulsecompute.io/v1.0.0-beta.4/packages/s3/) for the
