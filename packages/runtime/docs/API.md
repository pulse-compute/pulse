...
JavaScript](https://pulsecompute.io/v1.0.0-beta.2/reference/handler-authoring/). For provider and target
differences, use the [compatibility
matrix](https://pulsecompute.io/v1.0.0-beta.2/reference/compatibility-matrix/). For CLI and runtime failures,
use the stable codes in the [diagnostics
reference](https://pulsecompute.io/v1.0.0-beta.2/reference/diagnostics/).
...
The [static events guide](https://pulsecompute.io/v1.0.0-beta.2/guides/events/) owns the complete frame,
queue, target-eligibility, diagnostic, and Native-extension contract. The
source-bound [event example](https://pulsecompute.io/v1.0.0-beta.2/examples/11-events/) runs the same mixed project
...
[migration guide](https://pulsecompute.io/v1.0.0-beta.2/guides/compatibility-imports/). See the
[GRIP package guide](https://pulsecompute.io/v1.0.0-beta.2/packages/grip/) for the complete current surface.
...
guide](https://pulsecompute.io/v1.0.0-beta.2/packages/entities/), [entity/adapter
model](https://pulsecompute.io/v1.0.0-beta.2/concepts/entities-and-adapters/), and [executable
example](https://pulsecompute.io/v1.0.0-beta.2/examples/10-entities-tools/).
...
lifecycle guide](https://pulsecompute.io/v1.0.0-beta.2/guides/project-lifecycle/) and [CLI
reference](https://pulsecompute.io/v1.0.0-beta.2/reference/cli/).
