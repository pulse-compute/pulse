...
> **Canonical documentation:** [Package guide](https://pulsecompute.io/v1.0.0-beta.1/packages/entities/)
>
...
See the [Entities package guide](https://pulsecompute.io/v1.0.0-beta.1/packages/entities/)
for remediation and the [entity/adapter model](https://pulsecompute.io/v1.0.0-beta.1/concepts/entities-and-adapters/)
